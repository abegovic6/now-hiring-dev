...
-- insert into user
INSERT INTO aeesuser."user" (location_id, uuid, email, password, user_type, company_name, first_name, last_name, description, creation_ts, modification_ts, verified) VALUES (6, '1111', 'abegovic6@etf.unsa.ba', 'Sifra0001', 'PRIVATE', null, 'Amila', 'Begovic', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate vel...', now(), now(), true);
INSERT INTO aeesuser."user" (location_id, uuid, email, password, user_type, company_name, first_name, last_name, description, creation_ts, modification_ts, verified) VALUES (1, '2222', 'eleka1@etf.unsa.ba', 'Sifra0002', 'PRIVATE', null, 'Elma', 'Polutan', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate vel...', now(), now(), true);
INSERT INTO aeesuser."user" (location_id, uuid, email, password, user_type, company_name, first_name, last_name, description, creation_ts, modification_ts, verified) VALUES (1, '3333', 'skaleta1@etf.unsa.ba', 'Sifra0003', 'PRIVATE', null, 'Senija', 'Kaleta', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate vel...', now(), now(), true);
INSERT INTO aeesuser."user" (location_id, uuid, email, password, user_type, company_name, first_name, last_name, description, creation_ts, modification_ts, verified) VALUES (1, '4444', 'epanjeta1@etf.unsa.ba', 'Sifra0004', 'PRIVATE', null, 'Eldar', 'Panjeta', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate vel...', now(), now(), true);
INSERT INTO aeesuser."user" (location_id, uuid, email, password, user_type, company_name, first_name, last_name, description, creation_ts, modification_ts, verified) VALUES (9, '5555', 'begovicami5@gmail.com', 'Sifra0005', 'COMPANY', 'Google', null, null, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate vel...', now(), now(), true);
