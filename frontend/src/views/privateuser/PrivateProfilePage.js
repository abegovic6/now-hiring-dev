...
export default function PrivateProfilePage(props) {
    ...
    return (<>
                                    ...
                                    <MDBCardBody className="text-center">
                                        ...
                                        <p className="text-muted mb-1">{"Connections: " + connections.length}</p>
                                        {
                                            !isMy && !download && <div className="d-flex justify-content-center mb-2">
                                                {
                                                    !isConnected() &&
                                                    <MDBBtn className="subColorBackground addMargins">Connect</MDBBtn>
                                                }
                                                <MDBBtn outline
                                                        className="mainColorBackground addMargins blackText">Recommend</MDBBtn>
                                                <MDBBtn className="mainColorBackground addMargins blackText"
                                                        onClick={() => handleDownload(profile.displayValue)}>Download
                                                    CV</MDBBtn>
                                            </div>
                                        }
                                        {
                                            isMy && !download &&
                                            <Button onClick={() => handleDownload(profile.displayValue)}>Download
                                                CV</Button>
                                        }
                                            ...
                                            <MDBRow>
                                                ...
                                                <MDBCol>
                                                    <div className='containerButtonText'>
                                                        {
                                                            isMy && !download &&
                                                            <MDBCardImage style={{cursor: 'pointer'}} src={editSign} alt='...' height={20}
                                        ...
                                        <MDBCard className="mb-4 mb-md-0">
                                            <MDBCardBody>
                                                <div className='containerButtonText'>
                                                    {
                                                        isMy && !download &&
                                                        <MDBCardImage style={{cursor: 'pointer'}} src={plusSign} alt='...' height={30} onClick={() => setAddEducation(true)}/>
                                                    }
                                                    <MDBCardText style={{fontSize: '18px', fontWeight: "bold"}}
                                                                 className="mb-4">Education</MDBCardText>
                                                </div>
                                                    ...
                                                    educations && educations.map((education, index) => {
                                                        return <div key={index}>
                                                            <MDBCardText className="mb-1"
                                                                         style={{fontSize: '.9rem'}}>{education.title}</MDBCardText>
                                                            <MDBCardText className="mb-1"
                                                                         style={{fontSize: '.7rem'}}>{education.description}</MDBCardText>
                                                            {
                                        ...
                                        <MDBCard className="mb-4 mb-md-0">
                                            <MDBCardBody>
                                                <div className='containerButtonText'>
                                                    ...
                                                    {
                                                        isMy && !download &&
                                                        <MDBCardImage style={{cursor: 'pointer'}} src={plusSign}
                                                                      alt='...' height={30}
                                                                      onClick={() => setAddExperience(true)}/>
                                                    }
                                                    <MDBCardText style={{fontSize: '18px', fontWeight: "bold"}}
                                                                 className="mb-4">Experience</MDBCardText>
                                                </div>
                                                {
            ...
            {
                addEducation && <AddEducationModal open={addEducation} onClose={onAddEducationClose}/>
            }
