...
export default function AddEducationModal(props) {
    ...
    const handleSubmit = () => {
        ...
        post('/feature-service/education/add', experience, undefined, token)
            .then(response => {
                setIsLoading(false);
                if (response.errors) {
    ...
    return <>{isLoading ? <LoadingSpinner/> :
        <Modal show={open} onHide={onClose}>
                    ...
                    <MDBRow>
                        <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4'>
                            ...
                            <Form.Group className="mb-4">
                                ...
                                <Form.Label className="mb-4 mx-5 w-100">Valid Until</Form.Label>
                            </Form.Group>
            ...
            <Modal.Footer>
                <Button className='mainColorBackground blackText' onClick={handleClose}>
                    Cancel
                </Button>
