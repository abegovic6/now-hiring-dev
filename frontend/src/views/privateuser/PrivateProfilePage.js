                                ...
                                <MDBCardBody className="text-center">
                                    ...
                                    <p className="text-muted mb-1">{"Connections: " + connections.length}</p>
                                    {
                                        !isMy && !download && <div className="d-flex justify-content-center mb-2">
                                            ...
                                            <MDBBtn outline className="mainColorBackground addMargins blackText">Recommend</MDBBtn>
                                            <MDBBtn className="mainColorBackground addMargins blackText" onClick={() => handleDownload(profile.displayValue)}>Download
                                                CV</MDBBtn>
                                        </div>
                                    }
                                    {
                                        ...
                                        <MDBRow>
                                            ...
                                            <MDBCol>
                                                <div className='containerButtonText'>
                                                    {
                                                        isMy && !download &&
                                                        <MDBCardImage src={editSign} alt='...' height={20}
                                                    ...
                                                    return <div key={index}>
                                                                     ...
                                                                     style={{fontSize: '.7rem'}}>{education.description}</MDBCardText>
                                                        {
                                                            education.endMonth && education.endYear ?
                                                                <MDBCardText className="mb-4" style={{fontSize: '.7rem'}}>
